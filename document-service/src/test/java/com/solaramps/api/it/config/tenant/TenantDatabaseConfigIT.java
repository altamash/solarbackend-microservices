...
import com.solaramps.api.tenant.configuration.CurrentTenantIdentifierResolverImpl;
...
@ComponentScan(basePackages = {
        "com.solaramps.api.tenant.repository",
        "com.solaramps.api.tenant.model"})
@EnableJpaRepositories(basePackages = {
        "com.solaramps.api.tenant.repository",
        "com.solaramps.api.tenant.service"},
        entityManagerFactoryRef = "tenantEntityManagerFactory",
        transactionManagerRef = "tenantTransactionManager")
public class TenantDatabaseConfigIT {
...
//            @Qualifier("datasourceBasedMultitenantConnectionProvider")
            @Qualifier("dataSourceBasedMultiTenantConnectionProviderImplIT")
                    MultiTenantConnectionProvider connectionProvider,
            @Qualifier("currentTenantIdentifierResolver")
                    CurrentTenantIdentifierResolver tenantResolver) {
        LocalContainerEntityManagerFactoryBean emfBean = new LocalContainerEntityManagerFactoryBean();
        //All tenant related entities, repositories and service classes must be scanned
        emfBean.setPackagesToScan("com.solaramps.api.tenant"
                , "com.solaramps.api.configuration"
                , "com.solaramps.api.saas.configuration");
        emfBean.setJpaVendorAdapter(jpaVendorAdapter());
        emfBean.setPersistenceUnitName("tenantdb-persistence-unit");
        Map<String, Object> properties = new HashMap<>();
//        properties.put(Environment.MULTI_TENANT, org.hibernate.MultiTenancyStrategy.SCHEMA);
