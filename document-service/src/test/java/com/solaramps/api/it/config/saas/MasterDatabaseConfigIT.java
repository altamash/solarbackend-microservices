package com.solaramps.api.it.config.saas;
...
@EnableJpaRepositories(basePackages = {
        "com.solaramps.api.saas.model",
        "com.solaramps.api.saas.repository"},
        entityManagerFactoryRef = "masterEntityManagerFactory",
        transactionManagerRef = "masterTransactionManager")
public class MasterDatabaseConfigIT {

    private static final Logger LOG = LoggerFactory.getLogger(MasterDatabaseConfigIT.class);
    private static HikariDataSource hikariDataSource;
    @Autowired
    @Qualifier("masterDatabaseConfigPropertiesIT")
    private MasterDatabaseConfigPropertiesIT masterDbProperties;
    @Autowired
...
//        .getPackage().getName()});
        em.setPackagesToScan(
                "com.solaramps.api.saas.model",
                "com.solaramps.api.saas.repository",
                "com.solaramps.api.saas.module.com.solaramps.scheduler.model");
