...
@Configuration
public class DataSourceBasedMultiTenantConnectionProviderImplIT extends AbstractDataSourceBasedMultiTenantConnectionProviderImpl {

    private static final Logger LOGGER = LoggerFactory.getLogger(DataSourceBasedMultiTenantConnectionProviderImplIT.class);
        ...
        if (dataSourcesMtApp.isEmpty()) {
            ...
            for (MasterTenant masterTenant : masterTenants) {
                dataSourcesMtApp.put(masterTenant.getDbName(),
                        DataSourceUtilIT.createAndConfigureDataSource(masterTenant));
            }
        }
