echo off
echo -----------------------------------------
echo *** Deploy document-service on dev ***
echo -----------------------------------------
call cd document-service
call mvn clean
...
call az spring app deploy -n dev-document-service -g SIDevelopmentBE -s sidevspring --artifact-path target/DOCUMENT-SERVICE-0.0.1-SNAPSHOT.jar
call cd..
