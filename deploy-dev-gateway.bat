echo off
echo -----------------------------------------
echo *** Deploy gateway-service on dev ***
echo -----------------------------------------
...
call az spring app deploy -n dev-gateway-service -g SIDevelopmentBE -s sidevspring --artifact-path target/GATEWAY-SERVICE-0.0.1-SNAPSHOT.jar
call cd..
