echo off
echo -----------------------------------------
echo *** Deploy login-service on dev ***
echo -----------------------------------------
call cd login-service
call mvn clean
...
call az spring app deploy -n dev-login-service -g SIDevelopmentBE -s sidevspring --artifact-path target/LOGIN-SERVICE-0.0.1-SNAPSHOT.jar
call cd..
