...
@Configuration
public class PriorityEmailConsumerConfig {

    @Value(value = "${spring.kafka.bootstrap-servers}")
    private String bootstrapAddress;

    @Value(value = "${topic.alert-topic.priority-email.group-id}")
    private String emailAlertGroupId;

    public ConsumerFactory<String, WorkflowNotificationLogDTO> priorityEmailAlertConsumerFactory(String groupId) {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, WorkflowNotificationLogDTO> priorityEmailAlertKafkaListenerContainerFactory() {
        ...
        factory.setConsumerFactory(priorityEmailAlertConsumerFactory(emailAlertGroupId));
        return factory;
    }
}
