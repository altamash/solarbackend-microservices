...
@ComponentScan(basePackages = {
        "com.solaramps.api.commons.tenant.repository",
        "com.solaramps.api.commons.tenant.model"})
@EnableJpaRepositories(basePackages = {
        "com.solaramps.api.commons.tenant.repository",
        "com.solaramps.api.commons.tenant.service"},
...
//            @Qualifier("datasourceBasedMultitenantConnectionProvider")
            @Qualifier("dataSourceBasedMultiTenantConnectionProviderImpl")
                    MultiTenantConnectionProvider connectionProvider,
            @Qualifier("currentTenantIdentifierResolver")
                    CurrentTenantIdentifierResolver tenantResolver) {
        LocalContainerEntityManagerFactoryBean emfBean = new LocalContainerEntityManagerFactoryBean();
        //All tenant related entities, repositories and service classes must be scanned
        emfBean.setPackagesToScan("com.solaramps.api.commons.tenant"
                , "com.solaramps.api.commons.configuration"
                , "com.solaramps.api.commons.saas.configuration");
